...
public class exp1Parser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "exp1.g4"; }
	...
	public exp1Parser(TokenStream input) {
		super(input);
	...
	public static class StartContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(exp1Parser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(exp1Parser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof exp1Listener ) ((exp1Listener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof exp1Listener ) ((exp1Listener)listener).exitStart(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(exp1Parser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof exp1Listener ) ((exp1Listener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof exp1Listener ) ((exp1Listener)listener).exitExpr(this);
		}
	}
